...
namespace PLCKeygen
{
    ...
    public class PasswordDialog : Form
    {
        ...
        public PasswordDialog(string prompt = "Nhập mật khẩu:", string title = "Password")
        {
        ...
        private void InitializeComponents(string prompt, string title)
        {
            ...
            txtPassword.PasswordChar = '●';  // Use bullet character to hide password
        ...
        public static string Show(string prompt = "Nhập mật khẩu:", string title = "Password", Form owner = null)
        {
            using (var dialog = new PasswordDialog(prompt, title))
            {
